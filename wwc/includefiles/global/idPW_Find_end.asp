...
If gubun = "ID" Then 
	...
	If Not IsNull(User_ID) Then 
		Fnd_value = "조회하신 정보의 회원 아이디는 <span class='title2 bold t-info'>"&User_ID&"</span> 입니다."
	else
...
End If 
call CloseDB%>
 <div class="bg-mute" style="height:300px">	
	<table class="table bg-default">
		<tr>
			<td colspan="2"><img src="/images/index/index_logo.png" class="" /></td>
		</tr>
		<tr>
			<td colspan="2">
				<div class="cols-100 center pdt40 title2 pdb40"><%=Fnd_value%></div>
			</td>
		</tr>
		<tr>
			<td colspan="2" class="bg-mute ">
				<div class="cols-100 right mgt5">
					<a href="javascript:;" onclick="parent.$('#haedal').hide();location.href='/includefiles/html/blank.asp';parent.location.href='/contents/?st=sub100&sMenu=01'" class="btn btn-warning">로그인</a>
