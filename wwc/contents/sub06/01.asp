...
<%arng = "write"%>
	<section class="section1">
		<div class="innerWrap">
           ...
           <p>1. 개인정보의 수집 및 이용목적 : 월계종합사회복지관 브라보실버 활동과 관련된 내용 <br/>
	 					2. 개인정보의 보유 및 이용기간 : 월계종합사회복지관 브라보실버 활동 및 홈페이지 이용기간<br/>
	 					3. 보유기간 : 해당활동과 서비스가 제공되는 기간으로부터 3년 보관 수집 및 이용하는 기본 개인정보 항목 성명, 아이디, 이메일, 재학구분, 연락처, 주소, 문자/이메일/우편 발송 동의 거부 권리 및 동의 거부에 따른 제한사항 귀하는 개인정보 제공 및 동의를 거부할 권리가 있으며, 위 항목 동의 거부 시 월계종합사회복지관 브라보실버 활동 참여가 어려워질 수 있습니다.
           <div class="bsjoin-chkbox">
             <input type="checkbox" name="info01" id="info01">
             <label for="info01">동의합니다.</label>
           </div>
         </div>
				 <TABLE class="table table-bordered sub6-tb" summary="브라보실버 회원가입 정보 입력창">
					  <TBODY>
						<TR>
