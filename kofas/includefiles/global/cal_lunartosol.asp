...
if howconvert="1" then
 ...
 '------------------------음력변환--------------------
	...
	gf_lun2sol = exmonth &"-"&exday
 end function


'음력기념일
function holiday_lunar(danny3,danny4)
    danny_lu = danny3&"-"&danny4
    select case danny_lu
        case "01-01"
            danny_lunar = "<font color=#FF88B8><b> 설날</b></font><br>"
        case "01-04"
            danny_lunar = "<font color=#333333> 입춘</font><br>"
        case "01-19"
            danny_lunar = "<font color=#333333> 우수</font><br>"
        case "02-04"
            danny_lunar = "<font color=#333333> 경칩</font><br>"
        case "02-19"
            danny_lunar = "<font color=#333333> 춘분</font><br>"
        case "03-05"
            danny_lunar = "<font color=#333333> 한식</font><br>"
        case "04-06"
            danny_lunar = "<font color=#333333> 입하</font><br>"
        case "04-21"
            danny_lunar = "<font color=#333333> 소만</font><br>"
        case "05-05"
            danny_lunar = "<font color=#333333> 단오</font><br>"
        case "05-23"
            danny_lunar = "<font color=#333333> 하지</font><br>"
        case "06-08"
            danny_lunar = "<font color=#333333> 소서</font><br>"
        case "06-17"
            danny_lunar = "<font color=#333333> 초복</font><br>"
        case "06-24"
            danny_lunar = "<font color=#333333> 대서</font><br>"
        case "06-27"
            danny_lunar = "<font color=#333333> 중복</font><br>"
        case "07-07"
            danny_lunar = "<font color=#333333> 칠석</font><br>"
        case "07-11"
            danny_lunar = "<font color=#333333> 입추</font><br>"
        case "07-18"
            danny_lunar = "<font color=#333333> 말복</font><br>"
        case "07-26"
            danny_lunar = "<font color=#333333> 처서</font><br>"
        case "08-12"
            danny_lunar = "<font color=#333333> 백로</font><br>"
        case "08-14","08-16"
            danny_lunar = "<font color=#FF88B8><b>추석연휴</b></font><br>"
		case "08-15"
            danny_lunar = "<font color=#FF88B8><b> 추석</b></font><br>"
        case "08-27"
            danny_lunar = "<span color=#333333> 추분</font><br>"
        case "09-29"
            danny_lunar = "<font color=#333333> 상강</font><br>"
        case "10-15"
            danny_lunar = "<font color=#333333> 입동</font><br>"
        case "10-30"
            danny_lunar = "<font color=#333333> 소설</font><br>"
        case "11-14"
            danny_lunar = "<font color=#333333> 대설</font><br>"
        case "11-29"
            danny_lunar = "<font color=#333333> 동지</font><br>"
    end select
 end function
 %>