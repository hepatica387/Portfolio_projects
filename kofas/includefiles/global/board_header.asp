...
<!--#include virtual="/board/includefiles/css/board_css.asp"-->
...
<div class="wrapper">
	...
	<!-- 라인 메뉴 -->
	<section class="rows sub-menu-wrap">
	...
	<div class="board_wrap" id="board_wrap">
		<div class="section0-title center mgt120 ">
		   <h1 class="black"><%=arr_Menu_1depth(Int(sMenu)-1)%></h1>
		</div>
		<div id="body-cont" class="body-cont" >
